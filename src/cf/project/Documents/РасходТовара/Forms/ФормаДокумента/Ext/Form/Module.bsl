...
Процедура КартаЛояльностиПриИзмененииНаСервере() 
	...
	ВидКарты = Объект.КартаЛояльности.ВидКарты;
	...
	Скидка = ПараметрыПрограммыЛояльности[0].Скидка;	   
	ПравилаНачисления = ПараметрыПрограммыЛояльности[0].ПравилаНачисления;
	ПравилаСписания = ПараметрыПрограммыЛояльности[0].ПравилаСписания;
